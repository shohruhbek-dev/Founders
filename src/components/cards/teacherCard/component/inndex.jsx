function TeacherCard({ img, teacher, Experience, position, IELTS, isActive }) {
    return (
        <div className={`
            bg-white w-[300px] h-[400px] md:w-[360px] md:h-[420px] rounded-[20px] md:rounded-[30px] p-4 md:p-6 
        ...
        `}>
            ...
            <div className="flex flex-col gap-1 md:gap-2 items-center text-center mt-3 flex-1">
                <h1 className="text-xs md:text-2xl font-bold text-[#EC0000]">{teacher}</h1>
                <p className="text-[10px] md:text-base text-gray-700">
                ...
                <p className="max-w-[80%] text-[10px] md:text-base text-gray-700">
